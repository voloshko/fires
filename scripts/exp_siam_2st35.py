"""SPEC-51.2 на 35 чипах: сиам с двухэтапной потерей против передискр. сида с тем же seed (парно), рецепт v21."""
...
for r in ('bs-boost-swir-screen-v1', 'bs-siam-over-screen-20260918', 'bs-siam-2st-screen-20260918'):
...
S2 = np.load('research/bs-siam-2st-screen-20260918/probabilities.npy').astype(np.float32)
t = T > 0
def measure(ps, name):
...
measure(S2, 'двухэтапная потеря, сид 20260918')
