...
for f in range(5):
    ...
    for tag, name in (('diff', 'сиам diff-фьюжн (SPEC-51.1)'), ('2st', 'сиам двухэтапная потеря (SPEC-51.2)'), ('soft', 'сиам мягкие метки у кромки (SPEC-52)'), ('sar', 'сиам + радар под маской (SPEC-57)')):
